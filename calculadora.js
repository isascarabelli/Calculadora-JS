onload = () => {
    ...
    document.querySelector('#bt-2').onclick = function() {return digito(2)};
...
//Tratamento dos digitos numéricos
/*const*/ digito = (n) => {
    if(ehNovoNumero){
        sValor = '' + n;
        ehNovoNumero = false;
...
//Tratamento do botão no clique do botão decimal
const virgula = () => {
    if(ehNovoNumero){
        sValor = '0,';
        ehNovoNumero = false;
...
//converte a string so valor para un numero real
